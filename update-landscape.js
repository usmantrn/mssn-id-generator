...
let content = fs.readFileSync('src/components/idcard/IDCardTemplate.jsx', 'utf8');

const landscapeStart = content.indexOf('export const LandscapeCard =');
const landscapeEnd = content.indexOf('};', landscapeStart) + 2;

const newLandscape = `export const LandscapeCard = ({ member, assets, frontRef, backRef }) => {
...
content = content.substring(0, landscapeStart) + newLandscape + content.substring(landscapeEnd);
fs.writeFileSync('src/components/idcard/IDCardTemplate.jsx', content);
